    ...
    while True:
        async with AsyncSessionLocal() as session:
            try:
                ...
                logger.log('DB_ACCESS', f'Data deletion: model={SessionsOrm.__name__}, expired sessions removed')     
            except Exception as e:
                logger.log('DB_ACCESS', f'Data deletion: model={SessionsOrm.__name__}, error: {e}')    
