...
class MenuService(BaseService):
    ...
    async def get_menu_item(self,
        ...
        menu_item: MenuOrm | None = await self.get(session, id)
    ...
    async def create_menu_item(
        ...
        author: UsersOrm | None = await user_service.get(session, data_input.created_by_id)
        ...
        button_text_available: bool = await self._is_button_text_available(session, data_input.button_text)
    ...
    async def update_menu_item(
        ...
        menu_item: MenuOrm = await self.get(session, id)

        editor: UsersOrm | None = await user_service.get(session, data_input.updated_by_id)
